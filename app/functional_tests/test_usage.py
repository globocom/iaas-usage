...
class UsageFunctionalTestCase(FunctionalTestCaseBase):
    ...
    def _test_open_usage_report(self, driver):
        ...
        self.wait_for(lambda: driver.find_element_by_xpath("//*[@id=\"DataTables_Table_1_wrapper\"]").is_displayed())
    ...
    def _test_search(self, driver):
        ...
        self.wait_for(lambda: driver.find_element_by_xpath("//*[@id=\"DataTables_Table_1\"]").is_displayed())
        ...
        searched_records = driver.find_element_by_id("DataTables_Table_1_info").text
    ...
    def _test_clipboard_button(self, driver):
        driver.find_element_by_xpath("//div[@id='DataTables_Table_1_wrapper']/div/div/a/span").click()
