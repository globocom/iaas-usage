...
class VirtualMachineFunctionalTestCase(FunctionalTestCaseBase):
    ...
    def _test_add_and_remove_filter(self, driver):
        all_instances_count = driver.find_element_by_class_name(PageElements.TABLE_INFO_CLASS).text
        ...
        filtered_instances_count = driver.find_element_by_class_name(PageElements.TABLE_INFO_CLASS).text
    ...
    def _test_search(self, driver):
        ...
        searched_instances = driver.find_element_by_class_name(PageElements.TABLE_INFO_CLASS).text
    ...
    def _test_clipboard_button(self, driver):
        time.sleep(5)
        driver.find_element_by_class_name(PageElements.CLIPBOARD_COPY_BUTTON_CLASS).click()
...
class PageElements():
    ...
    CLIPBOARD_COPY_BUTTON_CLASS = "buttons-copy"
