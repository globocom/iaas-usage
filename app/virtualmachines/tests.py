...
class VirtualMachinesResourceTestCase(unittest.TestCase):
    ...
    def test_list_vms_given_cloudstack_api_error(self):
        ...
        list_users_mock.listGloboVirtualMachines.assert_called_with({"listall": "true", "simple": "true"})
    ...
    def test_list_vms_given_filters_passed(self):
        ...
        list_users_mock.listGloboVirtualMachines.assert_called_with(expected_params)
    ...
    def mock_cloudstack_list_vms(self, vms):
        ...
        list_vms_mock = Mock()
        list_vms_mock.listGloboVirtualMachines.return_value = vms
